...
![normal-merkle-tree](/indexed-merkle-tree/normal-merkle-tree.png")
...
![sparse-merkle-tree](/indexed-merkle-tree/sparse-merkle-tree.png")
...
![index-merkle-tree-1](/indexed-merkle-tree/index-merkle-tree-1.png")

2. Add a new value $v=30$

![index-merkle-tree-2](/indexed-merkle-tree/index-merkle-tree-2.png")

3. Add a new value $v=10$

![index-merkle-tree-3](/indexed-merkle-tree/index-merkle-tree-3.png")

4. Add a new value $v=20$

![index-merkle-tree-4](/indexed-merkle-tree/index-merkle-tree-4.png")
...
![subtree-insert-1](/indexed-merkle-tree/subtree-insert-1.png)

2. Update low nullifier for new nullifier $35$.

![subtree-insert-2](/indexed-merkle-tree/subtree-insert-2.png")
...
![subtree-insert-3](/indexed-merkle-tree/subtree-insert-3.png")

4. Update low nullifier for new nullifier $60$.

![subtree-insert-4](/indexed-merkle-tree/subtree-insert-4.png")

5. Update low nullifier for new nullifier $15$.

![subtree-insert-5](/indexed-merkle-tree/subtree-insert-5.png")

6. Update pointers for new nullifier $15$.

![subtree-insert-6](/indexed-merkle-tree/subtree-insert-6.png")

7. Insert subtree.

![subtree-insert-7](/indexed-merkle-tree/subtree-insert-7.png")
