...
Step-by-step guides for running different types of Aztec nodes.

## Overview

Learn how to set up and run different components of the Aztec network.
...
Navigate to the specific guide for detailed instructions.
