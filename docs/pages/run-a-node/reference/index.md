...
Reference documentation for running Aztec nodes.

## Overview

This section contains reference materials for node operators, including governance information, FAQs, and command references.
